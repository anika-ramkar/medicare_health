...
diabetes_model = pickle.load(open(r"C:\Users\Acer\Documents\Multiple-Disease-Prediction-Model-Deployment-using-StreamLit-main\models\diabetes_model_new.sav",'rb'))
heart_model = pickle.load(open(r"C:\Users\Acer\Documents\Multiple-Disease-Prediction-Model-Deployment-using-StreamLit-main\models\heart_disease_model.sav",'rb'))
parkinsons_model = pickle.load(open(r"C:\Users\Acer\Documents\Multiple-Disease-Prediction-Model-Deployment-using-StreamLit-main\models\parkinsons_model.sav",'rb'))
breast_model = pickle.load(open(r"C:\Users\Acer\Documents\Multiple-Disease-Prediction-Model-Deployment-using-StreamLit-main\models\breast_cancer_model.sav",'rb'))
